...
<head>
	...
	<title>Volpato Segurança</title>
	<meta name="author" content="Volpato Segurança">
	<meta name="description" content="A Volpato está há mais de duas décadas no mercado de segurança, atuando principalmente nas áreas de rastreamento veicular, portaria e segurança eletrônica. ">
	<meta name="keywords" content="alarme monitorado, rastreador veicular, portaria virtual,circuito fechado de tv, segurança eletrônica, segurança porto alegre">
	<!-- Styling -->
	<!-- Owl Stylesheets -->
				...
				<div class="col-md-6 col-sm-6 pull-right">
					<nav class="top__menu">
						<ul class="top-navigation js-dropdown">
							...
							<li>
								<a href="segunda-via-boleto.php">2° Via de Boleto</a>
							</li>
