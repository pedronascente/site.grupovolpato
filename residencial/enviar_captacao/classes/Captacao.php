...
class Captacao {
    ...
    public function formatarDados($Dados) {
        $explode_origem  = explode('&gclid=', $Dados['origem']);
        $Dados['origem'] = $explode_origem[0];
        switch ($Dados['origem']) {
            case ROTA1: $Dados['origem'] = "c1_can1_an1"; break;
            case ROTA2: $Dados['origem'] = "c1_can1_an2"; break;
            case ROTA3: $Dados['origem'] = "c1_can1_an3"; break;
            default :
               $Dados['origem'] = "grupovolpato_residencial";
        }
        $Array_Dados = array(
