...
.forgot-password:focus{
    ...
    <div class="container">
        <div class="card card-container">
            ...
            <img id="profile-img" class="profile-img-card" src="public/images/logo_vertical.png" />
            ...
            <form action="https://www.webalarme.com.br/acessoExterno.php" method="post" name="0.1_form" target="_blank"  class="form-signin">
                <span id="reauth-email" class="reauth-email"></span>
                 <input name="central" id="central" type="text" maxlength="200" class="form-control" placeholder="E-mail" required autofocus>
