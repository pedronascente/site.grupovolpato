                ...
                <form id="formulario-modal"  action="enviar_captacao/index.php" data-toggle="validator" role="form" method="post">
                    <div class="content py-3">
                        ...
                        <div class="form-group" >
                            ...
                            <input type="text" name="captacao_telefone1" id="telefone-modal"   class="phone_with_ddd form-control form-control form-control-lg" placeholder="SEU TELEFONE" required>
                        </div>
                        <div class=" form-group">
                            <input type="email"  name="captacao_email" class="form-control form-control-lg" placeholder="SEU E-MAIL" required>
                        </div>
                        <div class="form-group">
                            <select name="captacao_interesse"  id="interesse"  required="" class="custom-select form-control form-control-lg">
                                <option value="1">ALARME COMERCIAL</option>
                                <option value="2">ALARME RESIDÊNCIAL</option>
                            </select>
                        </div>
                        <div class=" form-group">
                            <textarea   name="captacao_pbs"    class="form-control form-control-lg  text-area" rows="5" placeholder="DIGITE SUA MENSAGEM" id="mensagem"></textarea>
                        </div>                                                                 
